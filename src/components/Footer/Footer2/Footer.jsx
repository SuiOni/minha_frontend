        ...
        <Box width={[1, 1, 1 / 3]}>
          <Wrapper>
            <ul className={socialList}>
              <li>
                <a title="Link to our Facebook page" href={props.facebook} target="_blank" rel="noopener">
                  {feather('facebook', ['30', '30'], svgStyles)}
                </a>
              </li>
              <li>
                <a title="Link to our Twitter account" href={props.twitter} target="_blank" rel="noopener">
                  {feather('twitter', ['30', '30'], svgStyles)}
                </a>
              </li>
              <li>
                <a title="Link to out Instragram account" href={props.instagram} target="_blank" rel="noopener">
