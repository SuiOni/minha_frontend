// port to styled-systems (.extend ? / withComponent) - change colors add theme provider
      ...
      <nav>
        ...
        <Box width="100%" px={[3, 3, 4]} className={mobileNav}>
          <ul>
            <li>Gatsbythemes.com starter</li>
            <li>
              <div onClick={this.toggleNav} role="button" tabIndex="0" onKeyPress={this.toggleNav}>
                MENU
              </div>
            </li>
          </ul>
        ...
        {this.state.mobileActive && (
          <MobileNav toggleNav={this.toggleNav} mobileStyle={mobileStyle}>
            <ul>
              ...
              <li>
                <div onClick={this.toggleNav} role="button" tabIndex="-1" onKeyPress={this.toggleNav}>
